			...
			<Server>
				...
				<LDevice inst="Disconnectors">
					...
					<LN prefix="DC" lnClass="CSWI" inst="1" lnType="Dummy.CSWI">
						<Inputs>
							<ExtRef iedName="IED2" ldInst="CBSW" lnClass="XSWI" lnInst="2"
								doName="Pos" daName="stVal" serviceType="GOOSE" srcCBName="GCB"
								srcLDInst="CBSW" srcLNClass="LLN0" intAddr="intAddr" />
							<ExtRef iedName="IED2" ldInst="CBSW" lnClass="XSWI" lnInst="2"
								doName="Pos" daName="q" />
		...
		<AccessPoint name="P1">
			<Server>
				...
				<LDevice inst="CircuitBreaker_CB1">
					...
					<LN lnClass="XCBR" inst="1" lnType="Dummy.XCBR1">
						<DOI name="Pos">
							<DAI name="ctlModel" desc="CTL Model">
								<Val>status-only</Val>
							</DAI>
						</DOI>
					</LN>
